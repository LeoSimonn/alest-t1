 ...
 * */
 ...
 public class DoubleLinkedListOfInteger {
    ...
    */
    ...
    /**
     * A) Método que conta o número de ocorrências do elemento passado como parâmetro na lista, retornando este valor
    ...
    /**
     * B) Método que percorre a lista removendo todos os elementos pares.
    ...
    public boolean removeEvenNumbers() {
        ...
        Node aux = header.next;
        while (aux != trailer) {
            Node next = aux.next; // Guarda a referência do próximo para não perder após a remoção
            if (aux.element != null && aux.element % 2 == 0) {
                aux.prev.next = aux.next;
                aux.next.prev = aux.prev;
                count--;
                removed = true;
